...
exports.DIRECTIONS = exports.UNINITIALIZED = exports.PAUSED = exports.RUNNING = undefined;
  ...
  _createClass(Game, [{
    ...
    value: function init() {
      ...
      bg.onload = function () {
        ...
        _this.drawStartScreen();
        _this.drawPauseScreen();
      };
    }
  }, {
    key: 'handleKeydown',
    ...
    value: function drawStartScreen() {
      ...
      this.startScreen = new createjs.Text("Press Space To Start", "50px Serif", "transparent");
      this.startScreen.x = 295;
      this.startScreen.y = 260;
      stage.addChild(this.startScreen);

      this.startScreenInterval = setInterval(function () {
        _this2.startScreen.color = _this2.startScreen.color === 'transparent' ? 'white' : 'transparent';
        stage.update();
      }, 700);
    ...
    value: function drawPauseScreen() {
      ...
      this.pauseScreen = new createjs.Text("PAUSED", "50px Serif", "transparent");
      this.pauseScreen.x = 400;
      this.pauseScreen.y = 260;
      this.pauseScreen.visible = false;
      stage.addChild(this.pauseScreen);

      this.pauseScreenInterval = setInterval(function () {
        _this3.pauseScreen.color = 'white';
        stage.update();
      }, 100);
    }
  }, {
    ...
    value: function hideBoard() {
      for (var i = 2; i < stage.children.length; i++) {
